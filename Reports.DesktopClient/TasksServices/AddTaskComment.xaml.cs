...
{
    public partial class AddTaskComment : Window
    {
        ...
        private void Update(object sender, RoutedEventArgs e)
        {
            ...
            Task task = AddComment(id, comment, App.User.Name);
            if (task == null)
            {
        ...
        private static Task AddComment(string guid, string comment, string employeeIdent)
        {
